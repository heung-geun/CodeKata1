...
function solution(k, m, score) {
  ...
  for (let i = m - 1; i < score.length; i += m) {
    if (score.length < m) {
      ...
      answer += scoreSort[i] * m;
      console.log("scoreSort", scoreSort[i]);
...
console.log(solution(3, 4, [1, 2, 3, 1, 2, 3, 1])); // 올바른 정답 = 8
console.log(solution(4, 3, [4, 1, 2, 2, 4, 4, 4, 4, 1, 2, 4, 2])); // 올바른 정답 33

// 다른분들은 다들 슬라이스로 잘라서 사용했구만...
