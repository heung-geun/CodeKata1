...
function solution(emptyCola, addedCola, firstCola) {
  let answer = 0;
  let i = firstCola;
  while (i >= emptyCola) {
    answer += Math.floor(i / emptyCola) * addedCola;
    i = i - Math.floor(i / emptyCola) * (emptyCola - addedCola);
  }
  return answer;
}

console.log("(4, 2, 20): ", solution(4, 2, 20));
console.log("(2, 1, 20): ", solution(2, 1, 20));
console.log("(9, 4, 20): ", solution(9, 4, 20));
